...
/***/ function(module, exports, __webpack_require__) {
	...
	haloApp.directive('haloTopic', function () {
		return {
			restrict: 'E',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeSchema = __webpack_require__(33);

	var _storeSchema2 = _interopRequireDefault(_storeSchema);

	var _storeReducer = __webpack_require__(105);

	var _storeReducer2 = _interopRequireDefault(_storeReducer);

	var _redux = __webpack_require__(409);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var schemaReducer = _storeReducer2.default.createReducer(_storeSchema2.default);
	var store = (0, _redux.createStore)(schemaReducer);

	var storeModule = window.angular.module('hl-store', []);

	storeModule.provider("$hlStore", function haloStoreProvider() {
		var getStateIterator = function getStateIterator(stateId, conditions) {
			return _storeReducer2.default.selectStateFromId(store.getState(), stateId, conditions);
		};

		var selectStateCollection = function selectStateCollection(stateId, conditions) {
			...
			if (arr.length === 0) {
				...
				return memoizeFn.apply(undefined, arr);
			}
		};

		var selectState = function selectState(stateId, conditions) {
			var iterator = getStateIterator(stateId, conditions);
			var selectedState = iterator.next();
			return selectedState.done ? undefined : selectedState.value.state;
		};

		var memoizeFn = (0, _memoize3.default)(function () {
		...
		var emptyMemoizeFn = (0, _memoize3.default)(function (state, conditions) {
			return [];
		});

		this.$get = function () {
			window.store = store;
			return _extends({}, store, { selectState: selectState, selectStateCollection: selectStateCollection });
		};
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module, global) {var checkGlobal = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stateTypes = __webpack_require__(34);
	...
	var schema = {
		localData: new _stateTypes.ObjectState({
			itemSchema: {
				users: new _stateTypes.CollectionState({
					itemSchema: {
						_id: getUniqueId,
						username: '',
						password: '',
				...
				categories: new _stateTypes.CollectionState({
					itemSchema: {
						_id: getUniqueId,
						name: '',
						creator_id: null
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CollectionState = exports.ObjectState = exports.NumberState = exports.PrimitiveState = exports.StateTypeInterface = undefined;

	var _isMatch2 = __webpack_require__(35);

	var _isMatch3 = _interopRequireDefault(_isMatch2);

	var _findIndex2 = __webpack_require__(81);

	var _findIndex3 = _interopRequireDefault(_findIndex2);

	var _endsWith2 = __webpack_require__(100);

	var _endsWith3 = _interopRequireDefault(_endsWith2);

	var _isPlainObject2 = __webpack_require__(104);
	...
	var StateTypeInterface = function () {
		function StateTypeInterface(options) {
			_classCallCheck(this, StateTypeInterface);

			// sanity check
			if (options.itemSchema !== undefined && !(0, _isPlainObject3.default)(options.itemSchema)) {
		...
		_createClass(StateTypeInterface, [{
			key: 'getId',
			...
			key: 'getReducer',
			value: function getReducer(relPath) {
			...
			key: 'getActionData',
			value: function getActionData(action) {
				return action.payload && action.payload.data;
			}
		}, {
			key: 'getActionFilter',
			value: function getActionFilter(action) {
				return action.payload && action.payload.filter && action.payload.filter[this.options.stateId];
			}
		}, {
			key: 'getLocalAction',
			value: function getLocalAction(type) {
				var localType;
				if ((0, _endsWith3.default)(type, '@' + this.options.stateId)) {
		...
		return StateTypeInterface;
	}();

	var PrimitiveState = function (_StateTypeInterface) {
		_inherits(PrimitiveState, _StateTypeInterface);

		function PrimitiveState() {
			_classCallCheck(this, PrimitiveState);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(PrimitiveState).apply(this, arguments));
		}

		_createClass(PrimitiveState, [{
			key: 'reducer',
			value: function reducer() {
				var state = arguments.length <= 0 || arguments[0] === undefined ? this.options.initState : arguments[0];
	...
	var NumberState = function (_PrimitiveState) {
		_inherits(NumberState, _PrimitiveState);

		function NumberState() {
			_classCallCheck(this, NumberState);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(NumberState).apply(this, arguments));
		}
			...
			value: function reducer() {
				...
				switch (localType) {
					...
					case 'DEC':
						return --state;
					default:
						return _get(Object.getPrototypeOf(NumberState.prototype), 'reducer', this).call(this, state, action);
				}
			}
		}]);
	...
	var ObjectState = function (_StateTypeInterface2) {
		_inherits(ObjectState, _StateTypeInterface2);

		function ObjectState(options) {
			_classCallCheck(this, ObjectState);

			var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(ObjectState).call(this, options));

			if (_this3.options.itemSchema === undefined) {
	...
	var CollectionState = function (_StateTypeInterface3) {
		_inherits(CollectionState, _StateTypeInterface3);

		function CollectionState(options) {
			_classCallCheck(this, CollectionState);

			var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(CollectionState).call(this, options));

			if (_this4.options.itemSchema === undefined) {
				throw new Error('itemSchema for collection must be defined');
			}
			return _this4;
		}

		_createClass(CollectionState, [{
			key: 'getInitState',
			value: function getInitState() {
				return [];
			}
			...
			value: function reducer() {
				...
				switch (localType) {
					case 'ADD_UNIQUE':
						if ((0, _findIndex3.default)(state, actionData) >= 0) {
							return state;
						}
					case 'ADD':
					...
					case 'UPDATE':
						...
						if (actionFilter !== undefined) {
							var found = state.findIndex(function (v) {
								return v === actionFilter || (0, _isMatch3.default)(v, actionFilter);
							});
							if (found >= 0) {
	...
	exports.StateTypeInterface = StateTypeInterface;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var stackClear = __webpack_require__(38),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isNull2 = __webpack_require__(106);
	...
	var _filter2 = __webpack_require__(107);

	var _filter3 = _interopRequireDefault(_filter2);

	var _set2 = __webpack_require__(115);
	...
	var _marked = [schemaIterator].map(regeneratorRuntime.mark);
	...
	function isSchemaAction(action) {
		return action.type && (0, _isString3.default)(action.type) && __schemaActionFormatPattern.test(action.type);
	}
	function matchSchemaAction(action) {
		if (action.type && (0, _isString3.default)(action.type)) {
			...
			if (schemaAction) {
				...
				if (hasStateId(stateId)) {
					...
					if (typeof localReducer === 'function') {
						...
						try {
							for (var _iterator = localStateIterator[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
								var localState = _step.value;
								...
								if (localState !== newLocalState) {
									...
									(0, _set3.default)(newState, localState.path, newLocalState);
								}
							}
						} catch (err) {
							_didIteratorError = true;
	...
	function subStateIterator(stateIndex) {
		return function (state, contrainst) {
			var subState = state[stateIndex];
			// apply contrainst to limit the number of subState
			if (contrainst) {
				if (Array.isArray(subState)) {
					return (0, _filter3.default)(subState, contrainst);
				} else if (typeof contrainst === 'function') {
					return contrainst(subState) ? subState : NOTFOUNDSTATE;
				} else if ((typeof subState === 'undefined' ? 'undefined' : _typeof(subState)) === 'object') {
					return (0, _isMatch3.default)(subState, contrainst) ? subState : NOTFOUNDSTATE;
				} else {
	...
	function schemaIterator(schema) {
		var mappingData = arguments.length <= 1 || arguments[1] === undefined ? [] : arguments[1];
		var child, childSchema, subMappingData;
		return regeneratorRuntime.wrap(function schemaIterator$(_context) {
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						...
						_context.t0 = regeneratorRuntime.keys(schema);
					...
					case 2:
						...
						child = _context.t1.value;
						childSchema = schema[child];

						if (!(childSchema instanceof _stateTypes.StateTypeInterface)) {
							_context.next = 13;
							break;
						}

						subMappingData = [].concat(_toConsumableArray(mappingData), [{
							path: child,
						...
						_context.next = 9;
						return { stateId: childSchema.getId(), mappingData: subMappingData, reducer: childSchema.getReducer() };
					...
					case 9:
						...
						return _context.delegateYield(schemaIterator(childSchema.getItemSchema(), subMappingData), 't2', 11);
					...
					case 13:
						if (!(0, _isPlainObject3.default)(childSchema)) {
							_context.next = 16;
							break;
						}

						subMappingData = [].concat(_toConsumableArray(mappingData), [{ path: child, iterator: subStateIterator(child), initState: {} }]);
						return _context.delegateYield(schemaIterator(schema[child], subMappingData), 't3', 16);
	...
	function loadSchema(schema) {
		...
		try {
			for (var _iterator2 = schemaIterator(schema)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
		...
		function initStateByMappingData(state, data) {
			...
			try {
				for (var _iterator3 = data.mappingData[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
					...
					if ((0, _isPlainObject3.default)(currentState) && currentState[mapping.path] === undefined) {
						...
						} else if ((0, _isNull3.default)(mapping.initState)) {
	...
	exports.default = {
		selectStateFromId: selectStateFromId,
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(124), 'Object', {defineProperty: __webpack_require__(128).f});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(124), 'Object', {defineProperties: __webpack_require__(161)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(171)('getOwnPropertyDescriptor', function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 19.1.2.7 Object.getOwnPropertyNames(O)
	__webpack_require__(171)('getOwnPropertyNames', function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(171)('freeze', function($freeze){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(171)('seal', function($seal){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(171)('preventExtensions', function($preventExtensions){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(171)('isFrozen', function($isFrozen){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(171)('isSealed', function($isSealed){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(171)('isExtensible', function($isExtensible){
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(137)(Function.call, __webpack_require__(165).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export   = __webpack_require__(126)
	  , $parseInt = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('anchor', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('big', function(createHTML){
	  return function big(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('blink', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('bold', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('fixed', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('fontcolor', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('fontsize', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('italics', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('link', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('small', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('strike', function(createHTML){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('sub', function(createHTML){
	  return function sub(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(256)('sup', function(createHTML){
	  return function sup(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!(TO_PRIMITIVE in proto))__webpack_require__(127)(proto, TO_PRIMITIVE, __webpack_require__(274));
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (__webpack_require__(147) != Object || !__webpack_require__(284)(arrayJoin)), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (fails(function(){
	  ...
	  test.sort(null);
	  // Old WebKit
	}) || !__webpack_require__(284)($sort)), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export  = __webpack_require__(126)
	  , $forEach = __webpack_require__(288)(0)
	  , STRICT   = __webpack_require__(284)([].forEach, true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(126)
	  , $map    = __webpack_require__(288)(1);

	$export($export.P + $export.F * !__webpack_require__(284)([].map, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(126)
	  , $filter = __webpack_require__(288)(2);

	$export($export.P + $export.F * !__webpack_require__(284)([].filter, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(126)
	  , $some   = __webpack_require__(288)(3);

	$export($export.P + $export.F * !__webpack_require__(284)([].some, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(126)
	  , $every  = __webpack_require__(288)(4);

	$export($export.P + $export.F * !__webpack_require__(284)([].every, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * !__webpack_require__(284)([].reduce, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * !__webpack_require__(284)([].reduceRight, true), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(284)($native)), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('copyWithin');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(126)
	  , $find   = __webpack_require__(288)(5)
	  , KEY     = 'find'
	  , forced  = true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(126)
	  , $find   = __webpack_require__(288)(6)
	  , KEY     = 'findIndex'
	  , forced  = true;
	// Shouldn't skip holes
	if(KEY in [])Array(1)[KEY](function(){ forced = false; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 21.2.5.3 get RegExp.prototype.flags()
	if(__webpack_require__(124) && /./g.flags != 'g')__webpack_require__(128).f(RegExp.prototype, 'flags', {
	  configurable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@match logic
	__webpack_require__(315)('match', 1, function(defined, MATCH, $match){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@replace logic
	__webpack_require__(315)('replace', 2, function(defined, REPLACE, $replace){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@search logic
	__webpack_require__(315)('search', 1, function(defined, SEARCH, $search){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@split logic
	__webpack_require__(315)('split', 2, function(defined, SPLIT, $split){
	  'use strict';
	  var isRegExp   = __webpack_require__(250)
	    , _split     = $split
	    , $push      = [].push
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY            = __webpack_require__(166)
	  ...
	  , task               = __webpack_require__(322).set
	...
	Wrapper = __webpack_require__(122)[PROMISE];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!setTask || !clearTask){
	  ...
	  // Node.js 0.8-
	  if(__webpack_require__(148)(process) == 'process'){
	    defer = function(id){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global    = __webpack_require__(121)
	  , macrotask = __webpack_require__(322).set
	  , Observer  = global.MutationObserver || global.WebKitMutationObserver
	  , process   = global.process
	  , Promise   = global.Promise
	  , isNode    = __webpack_require__(148)(process) == 'process'
	  , head, last, notify;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 23.2 Set Objects
	module.exports = __webpack_require__(327)('Set', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $WeakMap = module.exports = __webpack_require__(327)('WeakMap', wrapper, methods, weak, true, true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export      = __webpack_require__(126)
	  ...
	  , toLength     = __webpack_require__(151)
	  , isObject     = __webpack_require__(130)
	  , TYPED_ARRAY  = __webpack_require__(142)('typed_array')
	...
	__webpack_require__(307)(ARRAY_BUFFER);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(__webpack_require__(124)){
	  var LIBRARY             = __webpack_require__(166)
	    ...
	    , getPrototypeOf      = __webpack_require__(174)
	    , gOPN                = __webpack_require__(164).f
	    , isIterable          = __webpack_require__(338)
	    , getIterFn           = __webpack_require__(280)
	    , uid                 = __webpack_require__(136)
	    , wks                 = __webpack_require__(142)
	    , createArrayMethod   = __webpack_require__(288)
	    ...
	    , speciesConstructor  = __webpack_require__(321)
	    , ArrayIterators      = __webpack_require__(308)
	    , Iterators           = __webpack_require__(245)
	    , $iterDetect         = __webpack_require__(281)
	    , setSpecies          = __webpack_require__(307)
	    , arrayFill           = __webpack_require__(303)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classof   = __webpack_require__(190)
	  , ITERATOR  = __webpack_require__(142)('iterator')
	  , Iterators = __webpack_require__(245);
	module.exports = __webpack_require__(122).isIterable = function(it){
	  var O = Object(it);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(246)(Enumerate, 'Object', function(){
	  var that = this
	    , keys = that._k
	    , key;
	  do {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export  = __webpack_require__(126)
	  , getProto = __webpack_require__(174)
	  , anObject = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(301)('includes');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(198)('trimLeft', function($trim){
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	// https://github.com/sebmarkbage/ecmascript-string-left-right-trim
	__webpack_require__(198)('trimRight', function($trim){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export     = __webpack_require__(126)
	  ...
	  , toLength    = __webpack_require__(151)
	  , isRegExp    = __webpack_require__(250)
	  , getFlags    = __webpack_require__(311)
	...
	__webpack_require__(246)($RegExpStringIterator, 'RegExp String', function next(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(124) && $export($export.P + __webpack_require__(375), 'Object', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(166)|| !__webpack_require__(125)(function(){
	  var K = Math.random();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var metadata                  = __webpack_require__(390)
	  , anObject                  = __webpack_require__(129)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Set                     = __webpack_require__(328)
	  , from                    = __webpack_require__(381)
	  , metadata                = __webpack_require__(390)
	  , anObject                = __webpack_require__(129)
	  , getPrototypeOf          = __webpack_require__(174)
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(405)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(122).RegExp.escape;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _applyMiddleware = __webpack_require__(418);

	var _applyMiddleware2 = _interopRequireDefault(_applyMiddleware);

	var _compose = __webpack_require__(419);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(412),
	    isHostObject = __webpack_require__(413),
	    isObjectLike = __webpack_require__(414);
...
/***/ function(module, exports) {
	...
	var connectorModule = angular.module('hl-connector', []);

	exports.default = connectorModule;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _init = __webpack_require__(421);
	...
	var BaseConnector = function () {
		function BaseConnector(opts) {
			_classCallCheck(this, BaseConnector);
		...
		_createClass(BaseConnector, [{
			...
			key: 'getOption',
			value: function getOption(optName, def) {
	...
	_init2.default.factory('hlBaseConnector', function () {
		return BaseConnector;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	_init2.default.factory('hlStoreConnector', ["hlBaseConnector", function (BaseConnector) {
		// store Connector

		var StoreConnector = function (_BaseConnector) {
			_inherits(StoreConnector, _BaseConnector);

			function StoreConnector() {
				var opts = arguments.length <= 0 || arguments[0] === undefined ? { store: {}, stateId: '' } : arguments[0];

				_classCallCheck(this, StoreConnector);

				var isStore = function isStore(store) {
					if (!(0, _isPlainObject3.default)(store)) {
						throw new Error("Store option must be a plain object, got " + (typeof store === 'undefined' ? 'undefined' : _typeof(store)));
					}
					if (!(0, _isFunction3.default)(store.selectState)) {
						throw new Error("Store must have selectState function");
					}
					if (!(0, _isFunction3.default)(store.getState)) {
						throw new Error("Store must have getState function");
					}
					if (!(0, _isFunction3.default)(store.dispatch)) {
						throw new Error("Store must have dispatch function");
					}
					if (!(0, _isFunction3.default)(store.subscribe)) {
						throw new Error("Store must have subscribe function");
					}

					return true;
				};
				var isStateId = function isStateId(stateId) {
					if (!(0, _isString3.default)(stateId) || stateId === '') {
				...
				var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(StoreConnector).call(this, opts));

				_this.store = _this.getOption('store');
				_this.stateId = _this.getOption('stateId');

				return _this;
			}

			_createClass(StoreConnector, [{
				key: 'getActionPayload',
				value: function getActionPayload(model) {
					return {
				...
				key: 'getFilter',
				value: function getFilter(model) {
					var modelKey = model.getKey();
					var keyVal = model[modelKey];
					var filter = {};
				...
				key: '$isChanged',
				value: function $isChanged(model) {
					...
					return modelClass.$find(filter).then(function (stateModels) {
						var stateModel = stateModels.shift();
						if ((0, _isMatch3.default)(modelProps, stateModel.getProperties())) {
				...
				value: function $update(model) {
					...
					return new Promise(function (resolve, reject) {
						...
						var queryPromise = that.$queryRaw(that.getFilter(model));
				...
				key: '$queryRaw',
				value: function $queryRaw(condition) {
...
/***/ function(module, exports) {
	...
	var modelModule = window.angular.module('hl-model', ['hl-connector']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _init = __webpack_require__(426);
	...
	function getCollectionInstance(className, condition) {
		...
		collection.watchOnScope = function ($scope, propName) {
			...
			$scope[propName] = collection;
			var connector = className.$getConfig('connector');
			if (!connector) {
				throw new Error('Connector is not configured for this collection');
			}
			var unsubscribe = connector.$subscribe(function () {
				//check for changed on collection
				var query = className.$find(condition);
				query.then(function (currentCollection) {
					var isEqual = isEqualCollection(currentCollection, collection);
					if (!isEqual) {
						$scope.$apply(function () {
	...
	var BaseModel = function () {
	   ...
	   */
			value: function save() {
				...
				var connector = this.getConfig('connector');
				if (!connector) {
	   ...
	   */
			...
			value: function getKey() {
				...
				var className = this.getModelClass();
				var $properties = className.$properties();
				if (!(0, _isString3.default)($config.key)) {
	   ...
	   */
			...
			key: 'watchOnScope',
			value: function watchOnScope($scope, propName) {
				var _this = this;
				...
				var model = this;
				var unsubscribe = connector.$subscribe(function () {
					connector.$isChanged(model).then(function (isChanged) {
						if (isChanged) {
							$scope.$apply(function () {
	   ...
	   */
			...
			key: 'equal',
			value: function equal(targetModel) {
				var thisProps = this.getProperties();
				var targetModelProps = targetModel.getProperties();
				return (0, _isMatch3.default)(thisProps, targetModelProps);
			}
	   ...
	   */
			...
			value: function $new(data) {
				...
				// bind data
				if ((0, _isPlainObject3.default)(defaultProps)) {
					...
					try {
						for (var _iterator3 = propNames[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
							...
							var propVal;
							if ((0, _isPlainObject3.default)(data) && data[propName] !== undefined) {
	   ...
	   */
			...
			value: function $find(condition) {
				var className = this;
				var connector = className.$getConfig('connector');
				return connector.$query(condition).then(function (records) {
	   ...
	   */
			...
			value: function $findOne(condition) {
				return this.$find(condition).then(function (found) {
	...
	_init2.default.factory('hlBaseModel', function () {
		return BaseModel;
	});
...
/***/ function(module, exports) {
	...
	var userModule = window.angular.module('hl-user', ['hl-connector', 'hl-model', 'hl-store']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _init = __webpack_require__(429);
	...
	_init2.default.factory('hlUserModel', ["hlBaseModel", "hlStoreConnector", "$hlStore", function (BaseModel, StoreConnector, $hlStore) {
		var UserModel = function (_BaseModel) {
			...
			function UserModel() {
				...
				return _possibleConstructorReturn(this, Object.getPrototypeOf(UserModel).apply(this, arguments));
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	_init2.default.controller('hlUserController', ["$scope", "hlUserModel", function ($scope, UserModel) {
		//
		...
		setTimeout(function () {
			...
			anotherUser.then(function (user) {
				if (user) {
					user.email = 'another';
					user.save();
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	_init2.default.run(["$templateCache", function ($templateCache) {
	  $templateCache.put("halo/modules/user/template/profile.html", __webpack_require__(433));
	}]);

	// User List template config
	_init2.default.run(["$templateCache", function ($templateCache) {
	  $templateCache.put("halo/modules/user/template/list.html", __webpack_require__(434));
	}]);
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"jumbotron\">\r\n\t<h1>Hello, world!</h1>\r\n  <p>...</p>\r\n  <p><a class=\"btn btn-primary btn-lg\" href=\"#\" role=\"button\">Learn more</a></p>\r\n</div>\r\n<uib-tabset active=\"active\">\r\n  <uib-tab index=\"0\" heading=\"Users\">\r\n  \t<div class=\"hl-users-tab\">\r\n   \t\t<halo-user-list></halo-user-list> \r\n   \t</div>\r\n  </uib-tab>\r\n  <uib-tab index=\"$index + 1\" ng-repeat=\"tab in tabs\" heading=\"{{tab.title}}\" active=\"tab.active\" disable=\"tab.disabled\">\r\n    {{tab.content}}\r\n  </uib-tab>\r\n  <uib-tab index=\"3\" select=\"alertMe()\">\r\n    <uib-tab-heading>\r\n      <i class=\"glyphicon glyphicon-bell\"></i> Alert!\r\n    </uib-tab-heading>\r\n    I've got an HTML heading, and a select callback. Pretty cool!\r\n  </uib-tab>\r\n</uib-tabset>";

/***/ },
/* 434 */
/***/ function(module, exports) {

	module.exports = "<div ng-if=\"users.length > 0\">\r\n  <div class=\"row\">\r\n    <div ng-repeat=\"user in users | limitTo:paging.limit:((paging.currentPage - 1)*paging.limit + 1)\" class=\"col-md-3 col-xs-12\">\r\n      <div class=\"panel panel-default\">\r\n        <div class=\"panel-heading\">{{user.username}}</div>\r\n        <div class=\"panel-body\">\r\n          {{user.email}}\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <div class=\"row\">\r\n    <div class=\"center-block text-center\">\r\n      <uib-pagination class=\"pagination-sm\" total-items=\"users.length\" items-per-page=\"paging.limit\" max-size=\"4\" ng-model=\"paging.currentPage\" boundary-link-numbers=\"true\">\r\n      </uib-pagination>\r\n    </div>\r\n  </div>\r\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	_init2.default.directive('haloUserProfile', function () {
		return {
			restrict: 'E',
			controller: 'hlUserController',
	...
	// Halo User Profile directive
	_init2.default.directive('haloUserList', function () {
		return {
			restrict: 'E',
			scope: {},
